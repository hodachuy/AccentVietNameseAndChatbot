...
$(function () {
    ...
    // Init bot thue cho demo
    if (!setting.isAgentOnline) {
        setting.isTransferToBot = true;
        setting.BotID = '5041';
        $("#header-title").html('Trợ giúp luật');
    }
});
...
var messageBot = {
    ...
    getIcon: function (avatarBot) {
        ...
        if (setting.BotID = '5041') {
            templateAvatar += '<img src="' + _Host + 'assets/livechat/images/bot-legal-icon.png" class="rounded-circle" alt="image">';
        } else {
